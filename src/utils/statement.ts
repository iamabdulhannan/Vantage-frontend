...
export function buildStatementHtml(customer: Customer, opts: { companyName: string; showAd?: boolean }): string {
  ...
  <body>
    ...
    <div class="wrap">
      ...
      ${
        opts.showAd
          ? `<div style="margin-top:24px;border:1px solid #EBEDE3;border-radius:12px;padding:14px 16px;background:#F8FAF5;">
              <div style="font-size:9px;letter-spacing:1px;text-transform:uppercase;color:#939C94;margin-bottom:6px;">Sponsored</div>
              <div style="font-size:13px;font-weight:700;color:#171C19;">Run your business with Vantage</div>
              <div style="font-size:12px;color:#5C665F;margin-top:2px;">Digital khata, live profit and payment reminders. Businesses on Vantage collect payments 2x faster.</div>
              <div style="font-size:11px;color:#16A34A;font-weight:700;margin-top:6px;">vantage.app · Upgrade to remove ads from your statements</div>
            </div>`
          : ''
      }
...
export async function shareStatement(customer: Customer, opts: { companyName: string; showAd?: boolean }): Promise<void> {
